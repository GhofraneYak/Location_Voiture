    ...
    do
    {
        ...
        if (x==1)
            {
                ...
                else
               {
                    ...
                    cout<<"      ษอออออออออออออออออออGestion des Voituresอออออออออออออออออออออป"<<endl;
                    cout<<"      บ   -----------------------------------------------------  บ\n";
        ...
        if (x==2)
        {
            ...
            if(ag.agence_vide_de_parking())
            {
                ...
                do
                {
                      cout<<"      ษอออออออออออออออออออออออออGestion des parkingsอออออออออออออออออออออออออออออป\n";
                      cout<<"      บ   ----------------------------------------------------------------   บ\n";
        ...
        if (x==3)
        {
            do
            {
                ...
                cout<<"      บ                                                                                    บ\n";
                cout<<"      บ  (  | 4 | Ajouter un nouveau client                                              ) บ\n";
                cout<<"      บ                                                                                    บ\n";
               /* cout<<"      บ  (  | x | Effacer les clients dont leur derniere location depasse une date donnee) บ\n";
                cout<<"      บ                                                                                    บ\n";*/
                cout<<"      บ  (  | 0 | EXIT                                                                   ) บ\n";
                cout<<"      บ   ------------------------------------------------------------------------------   บ\n";
