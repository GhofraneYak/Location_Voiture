...
time_t now = time(0);
    ...
    do
    {
		...
		cout<<"      บ   -----------------------------------------------------  บ\n";
		cout<<"      บ  (  | 1 | Gestion des Voitures                         ) บ\n";
        cout<<"      บ                                                          บ\n";
        cout<<"      บ  (  | 2 | Gestion des Parkings                         ) บ\n";
        cout<<"      บ                                                          บ\n";
        cout<<"      บ  (  | 3 | Gestion des Clients                          ) บ\n";
        cout<<"      บ                                                          บ\n";
        cout<<"      บ  (  | 4 | Creation des Contrat                         ) บ\n";
        cout<<"      บ                                                          บ\n";
	    cout<<"      บ  (  | 0 | EXIT                                         ) บ\n";
	    cout<<"      บ   -----------------------------------------------------  บ\n";
        ...
        if (x==1)
            {
                ...
                else
               {
                    ...
                    cout<<"      ษอออออออออออออออออออGestion des Voituresอออออออออออออออออออป"<<endl;
                    cout<<"      บ   -----------------------------------------------------  บ\n";
                    cout<<"      บ  (  | 1 | Voiture la plus ancienne                     ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 2 | Voiture la plus louee                        ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 3 | Les voitures ayant un age entre 2 et 3 ans   ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 4 | Liste des voitures actuellement louees       ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 5 | Liste des voitures triees selon la categorie ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 6 | Liste des Voitures triees selon l'age        ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 7 | Changer le prix d'une Voiture                ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 8 | Supprimer une Voiture                        ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 9 | Afficher les information d'une Voiture       ) บ\n";
                    cout<<"      บ                                                          บ\n";
                    cout<<"      บ  (  | 10 | Ajouter  une nouvelle Voiture               ) บ\n";
                    cout<<"      บ                                                          บ\n";
        ...
        if (x==2)
        {
            ...
            if(ag.agence_vide_de_parking())
            {
                ...
                do
                {
                      cout<<"      ษอออออออออออออออออออออออออGestion des parkingsอออออออออออออออออออออออออป\n";
                      cout<<"      บ   ----------------------------------------------------------------   บ\n";
                      cout<<"      บ  (  | 1 | Afficher les informations d'un parking                   ) บ\n";
                      cout<<"      บ                                                                      บ\n";
                      cout<<"      บ  (  | 2 | Le prix moyen des voitures d'un parking                  ) บ\n";
                      cout<<"      บ                                                                      บ\n";
                      cout<<"      บ  (  | 3 | Grouper les voitures de 2 parking dans un 3eme parking   ) บ\n";
                      cout<<"      บ                                                                      บ\n";
                      cout<<"      บ  (  | 4 | Regrouper dans 2 parkings selon les categories           ) บ\n";
                      cout<<"      บ                                                                      บ\n";
                      cout<<"      บ  (  | 5 | Ajouter un nouveau parking                               ) บ\n";
                      cout<<"      บ                                                                      บ\n";
                      cout<<"      บ  (  | 6 | Vider un parking                                         ) บ\n";
                      cout<<"      บ                                                                      บ\n";
                      cout<<"      บ  (  | 7 | Deplacer une voiture                                     ) บ\n";
                      cout<<"      บ                                                                      บ\n";
                      cout<<"      บ  (  | 0 | EXIT                                                     ) บ\n";
                      cout<<"      บ   ----------------------------------------------------------------   บ\n";
        ...
        if (x==3)
        {
            do
            {
                cout<<"      ษออออออออออออออออออออออออออออออออGestion des clientsอออออออออออออออออออออออออออออออออป\n";
                cout<<"      บ   ------------------------------------------------------------------------------   บ\n";
                cout<<"      บ  (  | 1 | Afficher tous les clients                                              ) บ\n";
                cout<<"      บ                                                                                    บ\n";
                cout<<"      บ  (  | 2 | Afficher un client selon l'id                                          ) บ\n";
                cout<<"      บ                                                                                    บ\n";
                cout<<"      บ  (  | 3 | Liste des clients n'ayant pas loue de voiture depuis plus de 6 mois    ) บ\n";
                cout<<"      บ                                                                                    บ\n";
                cout<<"      บ  (  | 4 | Effacer les clients dont leur derniere location depasse une date donnee) บ\n";
                cout<<"      บ                                                                                    บ\n";
                cout<<"      บ  (  | 5 | Afficher le meilleur client                                            ) บ\n";
                cout<<"      บ                                                                                    บ\n";
                cout<<"      บ  (  | 0 | EXIT                                                                   ) บ\n";
                cout<<"      บ   ------------------------------------------------------------------------------   บ\n";
                cout<<"      ศออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผ\n";
