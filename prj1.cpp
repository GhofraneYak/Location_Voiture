    ...
    do
    {
        ...
        if (x==3)
        {
            do
            {
                ...
                cout<<"      บ   ------------------------------------------------------------------------------   บ\n";
                cout<<"      บ  (  | 1 | Liste des clients n'ayant pas loue de voiture depuis plus de 6 mois    ) บ\n";
                cout<<"      บ                                                                                    บ\n";
                cout<<"      บ  (  | 2 | Ajouter un nouveau client                                              ) บ\n";
                cout<<"      บ                                                                                    บ\n";
               /* cout<<"      บ  (  | 3 | Effacer les clients dont leur derniere location depasse une date donnee) บ\n";
                cout<<"      บ                                                                                    บ\n";*/
                cout<<"      บ  (  | 0 | EXIT                                                                   ) บ\n";
                cout<<"      บ   ------------------------------------------------------------------------------   บ\n";
